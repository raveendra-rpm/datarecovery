...
export const metadata: Metadata = {
  title: 'Our Clients | Trusted by Leading Companies | Data Storage Solutions',
  description: 'Data Storage Solutions is trusted by Airtel, Bharat Petroleum, ITC, SKF, BSNL, Blue Star and many more leading Bangalore companies for data recovery services.',
  alternates: { canonical: '/dss/clients' },
  openGraph: {
    title: 'Our Clients | Data Storage Solutions',
    description: 'Trusted by Airtel, Bharat Petroleum, ITC, SKF, BSNL, Blue Star and many more leading companies for data recovery services.',
    url: '/dss/clients',
    type: 'website',
  },
  twitter: {
...
export default function ClientsPage() {
  return (
    <main className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ name: 'Home', path: '/' }, { name: 'Clients' }]} />
