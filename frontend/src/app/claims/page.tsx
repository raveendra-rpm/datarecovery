...
export const metadata: Metadata = {
  title: 'Warranty Claims & Data Loss Prevention | Data Storage Solutions',
  description: 'Step-by-step warranty claim instructions for Seagate, Western Digital & Toshiba drives, plus expert guidance on data loss prevention (DLP) from Data Storage Solutions Bangalore.',
  alternates: { canonical: '/claims' },
  openGraph: {
    title: 'Warranty Claims & Data Loss Prevention | Data Storage Solutions',
    description: 'Step-by-step warranty claim instructions for Seagate, Western Digital & Toshiba drives, plus expert guidance on data loss prevention.',
    url: '/claims',
    type: 'website',
  },
  twitter: {
...
export default function ClaimsPage() {
  return (
    <main className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ name: 'Home', path: '/' }, { name: 'Claims' }]} />
      <PageHeader
        title="Claims"
