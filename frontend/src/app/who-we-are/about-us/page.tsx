...
export const metadata: Metadata = {
  title: 'About Us | 22+ Years of Data Recovery Experience | Data Storage Solutions',
  description: 'Data Storage Solutions (DSS) is a leading data recovery company in Bangalore with 22+ years of experience recovering data for individuals, SMEs and corporates.',
  alternates: { canonical: '/who-we-are/about-us' },
  openGraph: {
    title: 'About Us | Data Storage Solutions',
    description: 'Leading data recovery company in Bangalore with 22+ years of experience recovering data for individuals, SMEs and corporates.',
