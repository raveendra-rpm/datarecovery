...
export const metadata: Metadata = {
  title: 'Confidentiality Policy | Data Storage Solutions',
  description: 'Read our confidentiality and non-disclosure policy covering how Data Storage Solutions protects your data and information during the recovery process.',
  alternates: { canonical: '/who-we-are/confidentiality' },
  openGraph: {
    title: 'Confidentiality Policy | Data Storage Solutions',
    description: 'How Data Storage Solutions protects your data and information during the recovery process.',
    url: '/who-we-are/confidentiality',
    type: 'website',
  },
  twitter: {
...
export default function Confidentiality() {
  return (
    <main className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ name: 'Home', path: '/' }, { name: 'Confidentiality' }]} />
