...
export const metadata: Metadata = {
  title: 'Quality Policy | Data Storage Solutions',
  description: 'Our quality policy: highest standards, value, convenience, commitment and continual improvement in every data recovery job at Data Storage Solutions.',
  alternates: { canonical: '/who-we-are/quality-policy' },
  openGraph: {
    title: 'Quality Policy | Data Storage Solutions',
    description: 'Highest standards, value, convenience, commitment and continual improvement in every data recovery job.',
    url: '/who-we-are/quality-policy',
    type: 'website',
  },
  twitter: {
...
const values = [
  ...
  { icon: Users, label: 'Teamwork', desc: '22+ years of expert collaboration & dedication.' },
...
export default function QualityPolicy() {
  return (
    <main className="min-h-screen bg-white">
      <BreadcrumbSchema items={[{ name: 'Home', path: '/' }, { name: 'Quality Policy' }]} />
